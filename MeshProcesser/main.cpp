// MeshProcesser.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int, char**)
{
    ...
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Mesh Processer -ver 1.0 -by XJL"), WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
